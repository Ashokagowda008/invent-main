		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "plugin for export icon",
									"targetURL": "#cituxexportplugin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cituxexportplugin-display": {
								"semanticObject": "cituxexportplugin",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cit.ux.exportplugin",
									"url": sap.ui.require.toUrl("cit/ux/exportplugin/exportplugin")
								}
							}
						}
					}
