		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Car Pool Registration Application",
									"targetURL": "#poolregistration-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"poolregistration-display": {
								"semanticObject": "poolregistration",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=poolregistration",
									"url": sap.ui.require.toUrl("poolregistration")
								}
							}
						}
					}
