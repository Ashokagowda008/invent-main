					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Car Pool Booking List",
									"targetURL": "#bookinglist-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"bookinglist-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bookinglist",
									"url": sap.ui.require.toUrl("bookinglist")
								}
							}
						}
					}
