		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nsactivitytrackerapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsactivitytrackerapp-display": {
								"semanticObject": "nsactivitytrackerapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.activitytrackerapp",
									"url": sap.ui.require.toUrl("ns/activitytrackerapp")
								}
							}
						}
					}
