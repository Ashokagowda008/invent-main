		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Car Pool Booking",
									"targetURL": "#carpoolbooking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"carpoolbooking-display": {
								"semanticObject": "carpoolbooking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=carpoolbooking",
									"url": sap.ui.require.toUrl("carpoolbooking")
								}
							}
						}
					}
