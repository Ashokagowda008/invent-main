		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Custom chatbot for SAC",
									"targetURL": "#chatuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chatuimodule-display": {
								"semanticObject": "chatuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=chatuimodule",
									"url": sap.ui.require.toUrl("chatuimodule")
								}
							}
						}
					}
